...
public class ProcessarBoletos {
    ...
    public static List<Boleto> lerBancoBradesco(String nomeDoArquvio){
        try {
            BufferedReader reader = Files.newBufferedReader(Paths.get(nomeDoArquvio));
            String line;
            List<Boleto> boletos = new ArrayList<>();
            while((line = reader.readLine()) != null){
                String[] vetor = line.split(";");
